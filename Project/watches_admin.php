...
class="float"
 ><tr
class="fa fa-plus my-float"
 >
<td><select style="font-size: 20px;" name="selectcomp">
        <option style="font-size: 20px;" value="All">All</option>

        <option style="font-size: 20px;" value="Sonata">Sonata</option>

        <option style="font-size: 20px;" value="Titan">Titan</option>
        <option style="font-size: 20px;" value="Swizer">Swizer</option>
        <option style="font-size: 20px;" value="Smartwatch">Smart Watch</option>
        <option style="font-size: 20px;" value="Ajanta">Ajanta</option>
        <option style="font-size: 20px;" value="Sonam">Sonam</option>
...
// $sql = "SELECT pname,description,selectcomp,modelno, FROM addproducts ORDER BY pname";
 $sql = "SELECT * FROM `addproducts` WHERE 1";
...
// $delte = ;
 ...
 $abc=mysqli_query($con1, "DELETE FROM addproducts where modelno='$abcc'");
